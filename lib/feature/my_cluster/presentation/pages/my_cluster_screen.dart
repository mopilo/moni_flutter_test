        ...
        body: BlocProvider<MyClusterBloc>(
            ...
            child: BlocConsumer<MyClusterBloc, MyClusterState>(
              ...
              builder: (BuildContext context, state) => state
                          is MyClusterLoading ||
                      state is MyClusterInitial
                  ? const Center(child: CircularProgressIndicator())
                  : state is MyClusterError
                      ? Center(
                          child: Text(state.error.toString(),
                              style: GoogleFonts.dmSans()),
                        )
                      : state is MyClusterSuccessful
                          ? ListView(
                              children: [
                                Container(
                                  height: 305.h,
                                  decoration: const BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image:
                                            AssetImage(Assets.headerBackground),
                                        fit: BoxFit.cover),
                                  ),
                                  child: Column(
                                    children: [
